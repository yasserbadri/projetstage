import { isPresetInFavorites } from "../../config/logic";
...
export const authReducer=(state=initialState,action)=>{
    ...
    switch(action.type){
        ...
        case ADD_TO_FAVORITE_SUCCESS:
            return{
                ...state,isLoading:false,error:null,favorites:isPresetInFavorites(state.favorites,action.payload)
            ...
            case LOGIN_FAILURE:
                case GET_USER_FAILURE:
                    case ADD_TO_FAVORITE_FAILURE:
                        return {...state,isLoading:false,
                        error:action.payload ,success:null};
